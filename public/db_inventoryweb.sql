...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Des 2023 pada 13.42
...
(1, '13', '1', '8', 'BRG-1701590480333', 'Tenda Pelaminan', 'tenda-pelaminan', '2000000', '0', 'image.png', '2023-12-03 01:01:44', '2023-12-03 01:01:44');
...
(13, 'Tenda', 'tenda', NULL, '2022-11-25 08:27:33', '2023-12-03 00:15:58');
...
(8, 'JayaKuat', 'jayakuat', NULL, '2023-12-03 01:01:12', '2023-12-03 01:01:12');
...
(1, 'PELAMINAN-WEB', 'DBkr23yhjJqWHd3PAGisVAPRLH2eMywnz6A1aW9q.png', 'Mengelola Data Barang Masuk & Barang Keluar', '2022-11-15 03:51:04', '2023-12-03 00:28:49');
...
--
ALTER TABLE `tbl_barang`
  MODIFY `barang_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `tbl_barangkeluar`
--
ALTER TABLE `tbl_barangkeluar`
  MODIFY `bk_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_barangmasuk`
--
ALTER TABLE `tbl_barangmasuk`
  MODIFY `bm_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
